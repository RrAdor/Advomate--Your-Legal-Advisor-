    ...
    if (valid) {
      try {
        ...
        if (data && data.password === password) {
          ...
          // Use new session manager to store user data
          if (sessionManager.setUserSession(data)) {
            ...
            alert(
              "Login successful but there was an issue saving your session. Please try logging in again."
            );
          }
        } else {
